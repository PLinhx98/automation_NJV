    ...
    while True:
        ...
        if 20 < check_time.hour < 24:
            try:
                ...
                # TEMPORARYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYY khi nao sua inventory roi se sua lai cai nay
                df_merge.to_csv(f'G:/My Drive/Ninjavan Data/Fleet/Inventory/Inventory_{today}.csv', index=False)
...
# df = run_query(14881, col_list = inventory_col_list)
# print('done inventory!')
# df.check_date = f'{yesterday.year}-{str(yesterday.month).zfill(2)}-{str(yesterday.day).zfill(2)}'
